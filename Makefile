# Project Setup
PROJECT_NAME := configuration-aws-vpc
...
uptest: $(UPTEST) $(KUBECTL) $(KUTTL)
	...
	@KUBECTL=$(KUBECTL) KUTTL=$(KUTTL) CROSSPLANE_NAMESPACE=$(CROSSPLANE_NAMESPACE) $(UPTEST) e2e examples/vpc-xr.yaml --data-source="${UPTEST_DATASOURCE_PATH}" --setup-script=test/setup.sh --default-timeout=2400 || $(FAIL)
...
render:
	crossplane beta render examples/vpc-xr.yaml apis/basic/composition.yaml examples/function/function.yaml -r
